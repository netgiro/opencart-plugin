...
// Heading
$_['heading_title']      = 'Netgiro Checkout';

// Text
$_['text_extension']	 = 'Extensions';
$_['text_payment']       = 'Payment';
$_['text_success']       = 'Success: You have modified the Netgiro account details!';
...
$_['text_netgiro_post']	 = '<a href="https://www.netgiro.is" target="_blank"><img src="view/image/payment/netgiro_post.png" alt="Netgiro Checkout" title="Netgiro Checkout" style="border: 1px solid #EEEEEE;" /></a>';
...
$_['tooltip_succesful_status'] = 'Set the status orders get when successfully paid with Netgiro. Most common to use is Complete.';
...
$_['tooltip_total']   	   = 'The min total the cart must be to show this payment option. Recommend set to 100 or higher';
...
$_['help_mid']           = 'For <b>Test Mode</b> use: 881E674F-7891-4C20-AFD8-56FE2624C4B5';
$_['help_key']           = 'For <b>Test Mode</b> use: YCFd6hiA8lUjZejVcIf/LhRXO4wTDxY0JhOXvQZwnMSiNynSxmNIMjMf1HHwdV6cMN48NX3ZipA9q9hLPb9C1ZIzMH5dvELPAHceiu7LbZzmIAGeOf/OUaDrk2Zq2dbGacIAzU6yyk4KmOXRaSLi8KW8t3krdQSX7Ecm8Qunc/A=';
...
$_['help_debug'] 		 = '<b style="color:red;">Enable this setting when troubleshooting Netgiro Payments and send to netgiro@netgiro.is if support is needed. The file is located at "storage/logs/payment_netgiro_post_debug.log" accessible via FTP.</b>';

// Error
$_['error_permission']   = 'Warning: You do not have permission to modify this payment module!';
$_['error_fields']       = 'mid,key';
$_['error_mid']          = 'Provider Application ID is required!';
$_['error_key']          = 'Provider Secret Key is required!';
